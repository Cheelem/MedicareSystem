...
(function (e) {
    e.fn.columns = function (n) {
        ...
        typeof n == "string" ? this.each(function () {
            ...
            if (typeof t == "undefined" || !e.isFunction(t[n]))return e.error('没有方法 "' + n + '" 给列');
            var s = t[n].apply(t, i);
    ...
    var t = function (t, n) {
        ...
        this.create = function () {
            ...
            function s() {
                ...
                }) : t.rows.push('<tr class="' + t.evenRowClass + '"><td colspan="' + t.schema.length + '"><em>没有搜索到符合当前关键字的结果。</em></td>')
            }
...
(function (e, t) {
    ...
    function m(t, r) {
        ...
        function x(e) {
            ...
            if (!n(e) || e.length !== 2)throw new Error("非法的标签: " + e);
